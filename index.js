...
var imageContainers = document.getElementsByClassName('classifyOnClick');
...
function handleClick(event) {
    ...
    model.detect(event.target).then(function (predictions) {
        ...
        for (var n = 0; n < predictions.length; n++) {
            ...
            p.setAttribute('style', 'left: ' + predictions[n].bbox[0] + 'px;' +
                'top: ' + predictions[n].bbox[1] + 'px; ' +
                'width: ' + (predictions[n].bbox[2] - 10) + 'px;');
            var highlighter = document.createElement('div');
            highlighter.setAttribute('class', 'highlighter');
            highlighter.setAttribute('style', 'left: ' + predictions[n].bbox[0] + 'px;' +
                'top: ' + predictions[n].bbox[1] + 'px;' +
